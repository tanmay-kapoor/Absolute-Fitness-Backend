...
INSERT INTO `gyms` VALUES (1,'2025550118','55 Centre Avenue, #30, Austin, TX, 5634',156.33),(2,'2025550308','65-45 Otto Rd, Queens, NY 11385',253.99),(3,'7097534584','350 Tenth Ave, San Diego, CA 9210',75.00),(4,'8057779321','2565 Washington St Suite B, Boston, MA 0211',59.37),(5,'6011185333','515 S Figueroa St #102, Los Angeles, CA 90071',195.46),(6,'2025550250','1146 Harrison St, Seattle WA 98109',86.98);
...
CREATE TABLE `staff` (
  ...
  `type` enum('staff','trainer','admin') NOT NULL DEFAULT 'staff',
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getTokenExpiry` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
