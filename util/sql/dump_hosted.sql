CREATE DATABASE  IF NOT EXISTS `bdopbu4nv3knl3metrpn` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `bdopbu4nv3knl3metrpn`;
...
INSERT INTO `gym_admins` VALUES ('11111@gmail.com',1),('22222@gmail.com',2),('33333@gmail.com',3),('44444@gmail.com',4),('55555@gmail.com',5),('66666@gmail.com',6),('gg@wp.com',97),('new.admin45@gmail.com',105),('new1.admin@gmail.com',107),('qnew.admin@gmail.com',108),('new.admin4@gmail.com',109);
...
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `addDietPlan`(IN v_name VARCHAR(32), 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `addEquipmentForGym`(IN v_gym_id INT,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `addGym`(in v_branch VARCHAR(50), 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `addHealthRecord`(IN v_height DECIMAL(65, 2), 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `addImageUrlForGym`(IN v_image_url VARCHAR(200), 
								   IN v_gym_id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `addResetToken`(IN v_token VARCHAR(512), 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `addStaff`(IN v_staff_id VARCHAR(30),
						  IN v_name VARCHAR(50), 
                          IN v_phone VARCHAR(10), 
                          IN v_dob DATE,
                          IN v_sex ENUM("Male", "Female", "Other"),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `addTrainer`(IN v_staff_id VARCHAR(30),
						  IN v_name VARCHAR(50), 
                          IN v_phone VARCHAR(10), 
                          IN v_dob DATE,
                          IN v_sex ENUM("Male", "Female", "Other"),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `addUser`(IN v_email VARCHAR(30), in v_name VARCHAR(50), 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `addWorkoutPlan`(IN v_name VARCHAR(32), 
								IN v_description VARCHAR(512), 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `createNewAdminForGym`(IN v_staff_id VARCHAR(30),
								IN v_name VARCHAR(50), 
								IN v_phone VARCHAR(10), 
								IN v_dob DATE,
								IN v_sex ENUM("Male", "Female", "Other"),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `deleteDietPlan`(IN v_plan_id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `deleteEquipment`(IN v_equipment_id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `deleteEquipmentForGym`(IN v_gym_id INT,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `deleteGym`(IN v_gym_id INT)
BEGIN 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `deleteHealthRecord`(IN v_record_id INT)
BEGIN 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `deleteOldResetTokens`(IN v_username VARCHAR(30))
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `deleteStaff`(IN v_staff_id VARCHAR(30))
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `deleteUser`(IN v_email VARCHAR(30))
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `deleteWorkoutPlan`(IN v_plan_id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getAdmin`(IN v_staff_id VARCHAR(30))
BEGIN 
	SELECT * FROM staff 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getAllAdmins`()
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getAllAdminsForGym`(IN v_gym_id INT)
BEGIN 
	SELECT * FROM staff 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getAllDietPlans`()
BEGIN 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getAllEquipments`()
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getAllEquipmentsForGym`(IN v_gym_id INT)
BEGIN 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getAllFacilitiesForGym`(IN v_gym_id INT)
BEGIN 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getAllGyms`()
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getAllHealthRecords`()
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getAllHealthRecordsWithName`()
BEGIN
	SELECT * FROM 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getAllStaff`()
BEGIN
	SELECT * FROM staff;
END ;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getAllStaffForGym`(IN v_gym_id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getAllTrainersForGym`(IN v_gym_id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getAllUserHealthRecordsForTrainer`(IN v_trainer_id VARCHAR(30))
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getAllUsers`()
BEGIN
	SELECT * FROM users;
END ;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getAllUsersForGym`(IN v_gym_id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getAllWorkoutPlans`()
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getAlTrainersForGym`(IN v_gym_id INT)
BEGIN
	SELECT name, speciality, s.staff_id, years_of_exp, t.image_url, description, g.gym_id FROM 
	(staff s JOIN trainers t 
	ON s.staff_id = t.staff_id)
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getDietPlanForUser`(IN v_email VARCHAR(30))
BEGIN 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getEntryForLogin`(IN v_username VARCHAR(30))
BEGIN
	with entries as (
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getEquipment`(IN v_equipment_id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getGym`(IN v_gym_id INT)
BEGIN
	SELECT g.*, u.image_url FROM 
    gyms g LEFT JOIN gym_image_urls u
    ON g.gym_id = u.gym_id
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getHealthPlanForUser`(IN v_email VARCHAR(30))
BEGIN 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getHealthRecord`(IN v_record_id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getHealthRecordsForUser`(IN v_email VARCHAR(30))
BEGIN 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getResetToken`(IN v_token VARCHAR(512))
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getStaff`(IN v_staff_id VARCHAR(30))
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getTrainer`(IN v_staff_id varchar(30))
BEGIN 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getUser`(IN v_email VARCHAR(30))
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `getWorkoutPlanForUser`(IN v_email VARCHAR(30))
BEGIN 
	SELECT h.email, w.*,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `promoteStaffToAdmin`(IN v_staff_id VARCHAR(30))
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `promoteToPayingCustomer`(v_email VARCHAR(30))
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `resetPassword`(IN v_username VARCHAR(30), 
							   IN v_password VARCHAR(100), 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `updateDietPlan`(IN v_name VARCHAR(32), 
							 IN v_description VARCHAR(512), 
                             IN v_breakfast VARCHAR(100), 
                             IN v_lunch VARCHAR(100), 
                             IN v_dinner VARCHAR(100),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `updateEquipment`(IN v_equipment_id INT, 
								 IN v_name VARCHAR(20), 
                                 IN v_image_url VARCHAR(512))
BEGIN
	UPDATE equipments
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `updateEquipmentForGym`(IN v_gym_id INT, 
									   IN v_equipment_id INT, 
                                       IN v_quantity INT, 
                                       IN v_last_serviced DATE)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `updateGym`(in v_branch VARCHAR(50), 
						   in v_pincode VARCHAR(5),
						IN v_phone VARCHAR(10), 
                        IN v_location VARCHAR(50), 
                        IN v_membership_fee DECIMAL(65, 2),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `updateHealthRecord`(IN v_height DECIMAL(65, 2), 
								 IN v_weight DECIMAL(65,2), 
                                 IN v_date_calculated DATE, 
                                 IN v_bmi DECIMAL(65, 2), 
                                 IN v_email VARCHAR(30),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `updateStaff`(IN v_name VARCHAR(50), 
						     IN v_phone VARCHAR(10), 
                             IN v_dob DATE,
                             IN v_sex ENUM("Male", "Female", "Other"),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `updateTrainer`(IN v_staff_id VARCHAR(30),
							   IN v_name VARCHAR(50), 
                               IN v_phone VARCHAR(10), 
                               IN v_dob DATE,
                               IN v_sex ENUM("Male", "Female", "Other"),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `updateUser`(IN v_name VARCHAR(50), IN v_phone VARCHAR(10), 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` PROCEDURE `updateWorkoutPlan`(IN v_name VARCHAR(32), 
									IN v_description VARCHAR(512), 
									IN v_excercise_1 VARCHAR(32),
                                    IN v_excercise_2 VARCHAR(32),
                                    IN v_excercise_3 VARCHAR(32))
...
/*!50013 DEFINER=`u5xmcr8be4zzwpmt`@`bdopbu4nv3knl3metrpn-mysql.services.clever-cloud.com` SQL SECURITY DEFINER */
...
-- Dump completed on 2023-12-09 14:52:26
